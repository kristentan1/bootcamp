...
class Community(models.Model):
    ...
    user = models.ForeignKey(
        ...
        null=True,
        related_name="publisher4", # Attempting to solve error "news.News.user: (fields.E304) Reverse accessor for 'News.user' clashes with reverse accessor for 'Research.user' HINT: Add or change a related_name argument to the definition for 'News.user' or 'Research.user'."
    ...
    liked = models.ManyToManyField(
        ...
        settings.AUTH_USER_MODEL, blank=True, related_name="liked_community"
    )
    attended = models.ManyToManyField(
        settings.AUTH_USER_MODEL, blank=True, related_name="attended_community"
    )
    ...
    def get_absolute_url(self):
        ...
        return reverse("community:detail", kwargs={"uuid_id": self.uuid})
